import { SqlPrettyPrint } from "./Printer/SqlPrettyPrint";
import { StacktracePrettyPrint } from "./Printer/StacktracePrettyPrint";
...
const logLevelCssMap = new Map<string, string>(Object.entries(logLevelCssClassNames));
